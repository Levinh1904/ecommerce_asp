            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "0a1e22ff-b041-4ef3-b4aa-a709e9736184",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "52ec6974-890f-47cb-b2af-1863d27f5298",
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEBSpiMRJmdKQ4S/14VrQgq6RZYVYivhJVwkaL5v6Ory1qXVMpVrXPzRmX5FSmanV5Q==",
            ...
            modelBuilder.Entity("eShopSolution.Data.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CategoryId = 1,
                            DateCreated = new DateTime(2022, 4, 19, 15, 3, 19, 894, DateTimeKind.Local).AddTicks(7026),
                            Description = "",
                            Details = "",
                            Name = "iPhone 12 Pro",
                            Price = 28890000m,
                        ...
                        new
                        {
                            Id = 2,
                            CategoryId = 2,
                            DateCreated = new DateTime(2022, 4, 19, 15, 3, 19, 895, DateTimeKind.Local).AddTicks(9419),
                            Description = "",
                            Details = "",
                        ...
                        new
                        {
                            Id = 3,
                            CategoryId = 3,
                            DateCreated = new DateTime(2022, 4, 19, 15, 3, 19, 895, DateTimeKind.Local).AddTicks(9472),
                            Description = "",
                            Details = "",
                            Name = "Oppo Reno 5",
                            Price = 8290000m,
                        ...
                        new
                        {
                            Id = 4,
                            CategoryId = 4,
                            DateCreated = new DateTime(2022, 4, 19, 15, 3, 19, 895, DateTimeKind.Local).AddTicks(9476),
                            Description = "",
                            Details = "",
                            Name = "Vivo V21 5G",
                            Price = 9990000m,
                        ...
                        new
                        {
                            Id = 5,
                            CategoryId = 5,
                            DateCreated = new DateTime(2022, 4, 19, 15, 3, 19, 895, DateTimeKind.Local).AddTicks(9480),
                            Description = "",
                            Details = "",
                        ...
                        new
                        {
                            Id = 6,
                            CategoryId = 6,
                            DateCreated = new DateTime(2022, 4, 19, 15, 3, 19, 895, DateTimeKind.Local).AddTicks(9482),
                            Description = "",
                            Details = "",
                            Name = "Nokia 5.4",
                            Price = 3290000m,
